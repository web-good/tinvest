...
//
// Вселенная по умолчанию — UGLD, T, GAZP, DOMRF, FESH, WUSH, LENT, RENI, NVTK, LSNGP и IVAT. С
// 2026-08-17 это ВЕСЬ реестр: решением владельца в неё заведены три последних тикера, у которых
// литерал был, а решения не было; IVAT добавлен одиннадцатым 2026-08-18 сразу после калибровки.
// Walk-forward прошёл только
