// Package sber supplies the ticker and starting rsi_pullback Params for SBER (Sberbank).
//
...
// winning combination for SBER, replace the body with an explicit literal — from that point
...
// DefaultParams returns SBER's starting rsi_pullback parameters (pre-calibration).
