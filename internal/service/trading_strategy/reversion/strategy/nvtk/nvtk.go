// Package nvtk supplies the ticker and starting reversion Params for NVTK (Novatek).
...
// DefaultParams returns NVTK's starting reversion parameters (pre-calibration).
