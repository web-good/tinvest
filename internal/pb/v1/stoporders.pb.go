...
const file_stoporders_proto_rawDesc = "" +
	"\n" +
	"\x10stoporders.proto\x12%tinkoff.public.invest.api.contract.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\fcommon.proto\"\xf5\v\n" +
	...
	"\x11ExchangeOrderType\x12#\n" +
	"\x1fEXCHANGE_ORDER_TYPE_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aEXCHANGE_ORDER_TYPE_MARKET\x10\x01\x12\x1d\n" +
	"\x19EXCHANGE_ORDER_TYPE_LIMIT\x10\x02*o\n" +
	...
	"\x0fCancelStopOrder\x12=.tinkoff.public.invest.api.contract.v1.CancelStopOrderRequest\x1a>.tinkoff.public.invest.api.contract.v1.CancelStopOrderResponseBa\n" +
...
var (
	...
	file_stoporders_proto_rawDescData []byte
)

func file_stoporders_proto_rawDescGZIP() []byte {
	file_stoporders_proto_rawDescOnce.Do(func() {
		file_stoporders_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_stoporders_proto_rawDesc), len(file_stoporders_proto_rawDesc)))
	})
...
func file_stoporders_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_stoporders_proto_rawDesc), len(file_stoporders_proto_rawDesc)),
			NumEnums:      8,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
