...
1. **Адаптивные пороги.** Зоны перепроданности/перекупленности считаются как перцентили (P5, P15, P80, P90, P95) на исторических значениях RSI этой же акции (окно 100–200 недель RSI (закрытые + текущая формирующаяся)). У каждой бумаги — свои пороги.
